    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <span className="inline-block bg-red-600 text-white px-6 py-2 rounded-full uppercase tracking-[4px] text-sm font-bold">
            CONTACTE-NOS
          </span>
          ...
          <div className="relative min-h-[750px]">
            ...
            <div className="absolute inset-0 p-12 flex flex-col justify-between">
              ...
              <div>
                ...
                <p className="text-gray-200 mt-6 leading-8 text-lg">
          ...
          <div className="p-12">
            ...
            >
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-300 px-5 py-4 outline-none focus:border-red-600 transition"
                />
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-gray-300 px-5 py-4 resize-none outline-none focus:border-red-600 transition"
              />
                            <button
                type="submit"
                disabled={loading}
